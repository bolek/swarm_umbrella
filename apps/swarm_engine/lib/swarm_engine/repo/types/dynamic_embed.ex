defmodule SwarmEngine.Repo.Types.DynamicEmbed do
  ...
  defmacro __using__(_) do
    quote do
      ...
      def cast(%{type: _} = entity) do
        case resolve(entity) do
          {:ok, _type} ->
            {:ok, struct_to_map(entity)}
          {:error, _reason} ->
            :error
        end
      end
